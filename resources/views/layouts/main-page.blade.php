...
@section('content')
    <div class="container pricer">
        <div class="row">
            <div class="boxprice">
                <p>PostHurry is an innovative way to get your message out there. Using your personal Facebook profile, PostHurry gives you the ability to schedule and post content on multiple groups and pages at once; we call them “blasts” because that’s exactly what they do! With PostHurry, the possibilities are endless - use them to promote yourself, your business or host a contest. It's easy!</p>
                ...
                <p>It’s easy! PostHurry’s interface is easy and effective. In your PostHurry account, you can view current and previous blasts. Don’t want to go through the hassle of seeing how your post is doing on multiple pages? No problem. PostHurry includes analytical tools that will show you exactly how your content is doing. Ready to start blasting? Try PostHurry today!</p>
                <div class="limitoff">
                    <div class="limit">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="discount_val" class="form-control" placeholder="Optional" value="{{is_null($referral)?'':$referral}}">
