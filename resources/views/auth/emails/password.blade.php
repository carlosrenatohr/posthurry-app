<?php $link = url('reset', $token).'?email='.urlencode($user->getEmailForPasswordReset()) ?>
...
<head>
    ...
    <!-- MESSAGE SUBJECT -->
    <title>PostHurry - Reset your password</title>
...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0"
	...
	max-width: 560px;" class="container">
			...
			font-family: sans-serif;" class="paragraph">
                        You recently requested to reset your password for your PostHurry account.
			...
			color: #000000;
			font-family: sans-serif;" class="paragraph">
                        If you did not request a password reset, please ignore this email or reply to let us
                        know. This password is only valid for the next 24 hours.
                    </td>
                </tr>
			...
			color: #000000;
			font-family: sans-serif;" class="paragraph">
                        If You have trouble with button, press click to link below <br>
                        <a href="{{ $link }}" target="_blank" style="color: #127DB3; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 160%;">{{ $link }}</a>
                    </td>
                </tr>
